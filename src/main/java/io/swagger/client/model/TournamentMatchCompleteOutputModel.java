...
import io.swagger.client.model.GamingServerModel;
import io.swagger.client.model.StreamingServiceModel;
import io.swagger.client.model.TournamentCoreModel;
...
import io.swagger.client.model.TournamentMatchEvidenceCompleteOutputModel;
import io.swagger.client.model.TournamentMatchIssuedGamingServerModel;
...
import io.swagger.client.model.TournamentMatchPlayerModel;
import io.swagger.client.model.TournamentMatchStatisticsCompleteOutputModel;
...
public class TournamentMatchCompleteOutputModel {
  @SerializedName("GenerationTicks")
  private Long generationTicks = null;

  @SerializedName("Administrators")
  private List<EntityProfileModel> administrators = new ArrayList<EntityProfileModel>();

  @SerializedName("TournamentProfile")
  private TournamentCoreModel tournamentProfile = null;

  @SerializedName("GamingServer")
  private GamingServerModel gamingServer = null;

  @SerializedName("TeamAPlayers")
  private List<TournamentMatchPlayerModel> teamAPlayers = new ArrayList<TournamentMatchPlayerModel>();

  @SerializedName("TeamBPlayers")
  private List<TournamentMatchPlayerModel> teamBPlayers = new ArrayList<TournamentMatchPlayerModel>();

  @SerializedName("Evidence")
  private List<TournamentMatchEvidenceCompleteOutputModel> evidence = new ArrayList<TournamentMatchEvidenceCompleteOutputModel>();

  @SerializedName("IssuedGamingServerHistory")
  private List<TournamentMatchIssuedGamingServerModel> issuedGamingServerHistory = new ArrayList<TournamentMatchIssuedGamingServerModel>();

  @SerializedName("EndOfMapStatistics")
  private TournamentMatchStatisticsCompleteOutputModel endOfMapStatistics = null;
  ...
  public TournamentMatchCompleteOutputModel generationTicks(Long generationTicks) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel administrators(List<EntityProfileModel> administrators) {
    this.administrators = administrators;
    return this;
  }

  public TournamentMatchCompleteOutputModel addAdministratorsItem(EntityProfileModel administratorsItem) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "")
  public List<EntityProfileModel> getAdministrators() {
    return administrators;
  }

  public void setAdministrators(List<EntityProfileModel> administrators) {
    this.administrators = administrators;
  }

  public TournamentMatchCompleteOutputModel tournamentProfile(TournamentCoreModel tournamentProfile) {
    this.tournamentProfile = tournamentProfile;
    return this;
  }

   /**
   * Get tournamentProfile
   * @return tournamentProfile
  **/
  @ApiModelProperty(example = "null", value = "")
  public TournamentCoreModel getTournamentProfile() {
    return tournamentProfile;
  }

  public void setTournamentProfile(TournamentCoreModel tournamentProfile) {
    this.tournamentProfile = tournamentProfile;
  }

  public TournamentMatchCompleteOutputModel gamingServer(GamingServerModel gamingServer) {
    this.gamingServer = gamingServer;
    return this;
  }
  ...
  **/
  @ApiModelProperty(example = "null", value = "")
  public GamingServerModel getGamingServer() {
    return gamingServer;
  }

  public void setGamingServer(GamingServerModel gamingServer) {
    this.gamingServer = gamingServer;
  }

  public TournamentMatchCompleteOutputModel teamAPlayers(List<TournamentMatchPlayerModel> teamAPlayers) {
    this.teamAPlayers = teamAPlayers;
    return this;
  }

  public TournamentMatchCompleteOutputModel addTeamAPlayersItem(TournamentMatchPlayerModel teamAPlayersItem) {
    this.teamAPlayers.add(teamAPlayersItem);
    return this;
  }
  ...
  **/
  @ApiModelProperty(example = "null", value = "")
  public List<TournamentMatchPlayerModel> getTeamAPlayers() {
    return teamAPlayers;
  }

  public void setTeamAPlayers(List<TournamentMatchPlayerModel> teamAPlayers) {
    this.teamAPlayers = teamAPlayers;
  }

  public TournamentMatchCompleteOutputModel teamBPlayers(List<TournamentMatchPlayerModel> teamBPlayers) {
    this.teamBPlayers = teamBPlayers;
    return this;
  }

  public TournamentMatchCompleteOutputModel addTeamBPlayersItem(TournamentMatchPlayerModel teamBPlayersItem) {
    this.teamBPlayers.add(teamBPlayersItem);
    return this;
  }
  ...
  **/
  @ApiModelProperty(example = "null", value = "")
  public List<TournamentMatchPlayerModel> getTeamBPlayers() {
    return teamBPlayers;
  }

  public void setTeamBPlayers(List<TournamentMatchPlayerModel> teamBPlayers) {
    this.teamBPlayers = teamBPlayers;
  }

  public TournamentMatchCompleteOutputModel evidence(List<TournamentMatchEvidenceCompleteOutputModel> evidence) {
    this.evidence = evidence;
    return this;
  }

  public TournamentMatchCompleteOutputModel addEvidenceItem(TournamentMatchEvidenceCompleteOutputModel evidenceItem) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "")
  public List<TournamentMatchEvidenceCompleteOutputModel> getEvidence() {
    return evidence;
  }

  public void setEvidence(List<TournamentMatchEvidenceCompleteOutputModel> evidence) {
    this.evidence = evidence;
  }

  public TournamentMatchCompleteOutputModel issuedGamingServerHistory(List<TournamentMatchIssuedGamingServerModel> issuedGamingServerHistory) {
    this.issuedGamingServerHistory = issuedGamingServerHistory;
    return this;
  }

  public TournamentMatchCompleteOutputModel addIssuedGamingServerHistoryItem(TournamentMatchIssuedGamingServerModel issuedGamingServerHistoryItem) {
    this.issuedGamingServerHistory.add(issuedGamingServerHistoryItem);
    return this;
  }

   /**
   * Get issuedGamingServerHistory
   * @return issuedGamingServerHistory
  **/
  @ApiModelProperty(example = "null", value = "")
  public List<TournamentMatchIssuedGamingServerModel> getIssuedGamingServerHistory() {
    return issuedGamingServerHistory;
  }

  public void setIssuedGamingServerHistory(List<TournamentMatchIssuedGamingServerModel> issuedGamingServerHistory) {
    this.issuedGamingServerHistory = issuedGamingServerHistory;
  }

  public TournamentMatchCompleteOutputModel endOfMapStatistics(TournamentMatchStatisticsCompleteOutputModel endOfMapStatistics) {
    this.endOfMapStatistics = endOfMapStatistics;
    return this;
  }

   /**
   * Get endOfMapStatistics
   * @return endOfMapStatistics
  **/
  @ApiModelProperty(example = "null", value = "")
  public TournamentMatchStatisticsCompleteOutputModel getEndOfMapStatistics() {
    return endOfMapStatistics;
  }

  public void setEndOfMapStatistics(TournamentMatchStatisticsCompleteOutputModel endOfMapStatistics) {
    this.endOfMapStatistics = endOfMapStatistics;
  }
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel tournamentMatchId(Long tournamentMatchId) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel tournamentId(Long tournamentId) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel gameTitleId(Integer gameTitleId) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel isTeamTournament(Boolean isTeamTournament) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel matchIsAwaitingMapVote(Boolean matchIsAwaitingMapVote) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel matchIsLive(Boolean matchIsLive) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel matchLiveDateTime(DateTime matchLiveDateTime) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel matchIsComplete(Boolean matchIsComplete) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel matchCompleteDateTime(DateTime matchCompleteDateTime) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel matchIsFinalized(Boolean matchIsFinalized) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel matchFinalizedDateTime(DateTime matchFinalizedDateTime) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel enableMatchLobby(Boolean enableMatchLobby) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel allowCheckinDateTime(DateTime allowCheckinDateTime) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel scheduledStartDateTime(DateTime scheduledStartDateTime) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel scheduledForfeitDateTime(DateTime scheduledForfeitDateTime) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel entityOwnerId(Long entityOwnerId) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel entityOwnerProfile(EntityProfileModel entityOwnerProfile) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel entityParticipantA(TournamentMatchParticipantModel entityParticipantA) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel entityParticipantB(TournamentMatchParticipantModel entityParticipantB) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel roundNumber(Integer roundNumber) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel roundLevelTypeId(Integer roundLevelTypeId) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel matchNumber(Integer matchNumber) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel numberOfMaps(Integer numberOfMaps) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel mapNumber(Integer mapNumber) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel currentGameTitleMapNameId(Integer currentGameTitleMapNameId) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel gameTitleMapFileName(String gameTitleMapFileName) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel gameTitleMapProperName(String gameTitleMapProperName) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel gamingServerRegionId(Integer gamingServerRegionId) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel gamingServerRegionName(String gamingServerRegionName) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel isBracket(Boolean isBracket) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel allowRescheduling(Boolean allowRescheduling) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel willBroadcast(Boolean willBroadcast) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel broadcastUrl(String broadcastUrl) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel automaticGoLiveOnSchedule(Boolean automaticGoLiveOnSchedule) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel minutesAfterStartToForfeit(Integer minutesAfterStartToForfeit) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel minutesBeforeStartToAllowCheckin(Integer minutesBeforeStartToAllowCheckin) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel serverSendPlayerSummaryStatistics(Boolean serverSendPlayerSummaryStatistics) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel gamingServerId(Integer gamingServerId) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel entityPlayerControllerId(Long entityPlayerControllerId) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel allTeamAPlayersReady(Boolean allTeamAPlayersReady) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel teamAIsReady(Boolean teamAIsReady) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel allTeamBPlayersReady(Boolean allTeamBPlayersReady) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel teamBIsReady(Boolean teamBIsReady) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel scoreManuallyReportedDateTime(DateTime scoreManuallyReportedDateTime) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel scoreManuallyReported(Boolean scoreManuallyReported) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel scoreManuallyReportedByPlayerId(Long scoreManuallyReportedByPlayerId) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel scoreManuallyReportedByTeamA(Boolean scoreManuallyReportedByTeamA) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel scoreManuallyApplyToEntireRound(Boolean scoreManuallyApplyToEntireRound) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel mapsPlayed(List<TournamentMatchMapsPlayedModel> mapsPlayed) {
    this.mapsPlayed = mapsPlayed;
    return this;
  }

  public TournamentMatchCompleteOutputModel addMapsPlayedItem(TournamentMatchMapsPlayedModel mapsPlayedItem) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel dispute(TournamentMatchDisputeModel dispute) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel newServerRequested(Boolean newServerRequested) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel newServerRequestedEntityId(Long newServerRequestedEntityId) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel newServerRequestedByTeamA(Boolean newServerRequestedByTeamA) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel newServerRequestedCount(Integer newServerRequestedCount) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel needsAssistance(Boolean needsAssistance) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel allowedSpectators(String allowedSpectators) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel streamingServiceId(Integer streamingServiceId) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel manualMode(Boolean manualMode) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel manualServerConnectionInfo(String manualServerConnectionInfo) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel streamingService(StreamingServiceModel streamingService) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel assistanceRequests(List<TournamentMatchAssistanceModel> assistanceRequests) {
    this.assistanceRequests = assistanceRequests;
    return this;
  }

  public TournamentMatchCompleteOutputModel addAssistanceRequestsItem(TournamentMatchAssistanceModel assistanceRequestsItem) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel lastUpdatedDateTime(DateTime lastUpdatedDateTime) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel serverConfigurationFileName(String serverConfigurationFileName) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel matchConnectionInstructions(String matchConnectionInstructions) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel matchAdministratorId(Long matchAdministratorId) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel actionLog(List<TournamentMatchActionLogModel> actionLog) {
    this.actionLog = actionLog;
    return this;
  }

  public TournamentMatchCompleteOutputModel addActionLogItem(TournamentMatchActionLogModel actionLogItem) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel playback(List<TournamentMatchPlaybackModel> playback) {
    this.playback = playback;
    return this;
  }

  public TournamentMatchCompleteOutputModel addPlaybackItem(TournamentMatchPlaybackModel playbackItem) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel qualifierGroupNumber(Integer qualifierGroupNumber) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel isQualifier(Boolean isQualifier) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel hasTieBreaker(Boolean hasTieBreaker) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel tieBreakerCount(Integer tieBreakerCount) {
  ...
  **/
  ...
  public TournamentMatchCompleteOutputModel mapVotingResult(TournamentMatchMapVotingModel mapVotingResult) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TournamentMatchCompleteOutputModel tournamentMatchCompleteOutputModel = (TournamentMatchCompleteOutputModel) o;
    return Objects.equals(this.generationTicks, tournamentMatchCompleteOutputModel.generationTicks) &&
        Objects.equals(this.administrators, tournamentMatchCompleteOutputModel.administrators) &&
        Objects.equals(this.tournamentProfile, tournamentMatchCompleteOutputModel.tournamentProfile) &&
        Objects.equals(this.gamingServer, tournamentMatchCompleteOutputModel.gamingServer) &&
        Objects.equals(this.teamAPlayers, tournamentMatchCompleteOutputModel.teamAPlayers) &&
        Objects.equals(this.teamBPlayers, tournamentMatchCompleteOutputModel.teamBPlayers) &&
        Objects.equals(this.evidence, tournamentMatchCompleteOutputModel.evidence) &&
        Objects.equals(this.issuedGamingServerHistory, tournamentMatchCompleteOutputModel.issuedGamingServerHistory) &&
        Objects.equals(this.endOfMapStatistics, tournamentMatchCompleteOutputModel.endOfMapStatistics) &&
        Objects.equals(this.tournamentMatchStateId, tournamentMatchCompleteOutputModel.tournamentMatchStateId) &&
        Objects.equals(this.tournamentMatchExtendedStateId, tournamentMatchCompleteOutputModel.tournamentMatchExtendedStateId) &&
        Objects.equals(this.requireManualScoreReport, tournamentMatchCompleteOutputModel.requireManualScoreReport) &&
        Objects.equals(this.tournamentMatchId, tournamentMatchCompleteOutputModel.tournamentMatchId) &&
        Objects.equals(this.tournamentId, tournamentMatchCompleteOutputModel.tournamentId) &&
        Objects.equals(this.gameTitleId, tournamentMatchCompleteOutputModel.gameTitleId) &&
        Objects.equals(this.isTeamTournament, tournamentMatchCompleteOutputModel.isTeamTournament) &&
        Objects.equals(this.matchIsAwaitingMapVote, tournamentMatchCompleteOutputModel.matchIsAwaitingMapVote) &&
        Objects.equals(this.matchIsLive, tournamentMatchCompleteOutputModel.matchIsLive) &&
        Objects.equals(this.matchLiveDateTime, tournamentMatchCompleteOutputModel.matchLiveDateTime) &&
        Objects.equals(this.matchIsComplete, tournamentMatchCompleteOutputModel.matchIsComplete) &&
        Objects.equals(this.matchCompleteDateTime, tournamentMatchCompleteOutputModel.matchCompleteDateTime) &&
        Objects.equals(this.matchIsFinalized, tournamentMatchCompleteOutputModel.matchIsFinalized) &&
        Objects.equals(this.matchFinalizedDateTime, tournamentMatchCompleteOutputModel.matchFinalizedDateTime) &&
        Objects.equals(this.enableMatchLobby, tournamentMatchCompleteOutputModel.enableMatchLobby) &&
        Objects.equals(this.allowCheckin, tournamentMatchCompleteOutputModel.allowCheckin) &&
        Objects.equals(this.allowCheckinDateTime, tournamentMatchCompleteOutputModel.allowCheckinDateTime) &&
        Objects.equals(this.scheduledStartDateTime, tournamentMatchCompleteOutputModel.scheduledStartDateTime) &&
        Objects.equals(this.scheduledForfeitDateTime, tournamentMatchCompleteOutputModel.scheduledForfeitDateTime) &&
        Objects.equals(this.entityOwnerId, tournamentMatchCompleteOutputModel.entityOwnerId) &&
        Objects.equals(this.entityOwnerProfile, tournamentMatchCompleteOutputModel.entityOwnerProfile) &&
        Objects.equals(this.entityParticipantA, tournamentMatchCompleteOutputModel.entityParticipantA) &&
        Objects.equals(this.entityParticipantB, tournamentMatchCompleteOutputModel.entityParticipantB) &&
        Objects.equals(this.roundNumber, tournamentMatchCompleteOutputModel.roundNumber) &&
        Objects.equals(this.roundLevelTypeId, tournamentMatchCompleteOutputModel.roundLevelTypeId) &&
        Objects.equals(this.matchNumber, tournamentMatchCompleteOutputModel.matchNumber) &&
        Objects.equals(this.numberOfMaps, tournamentMatchCompleteOutputModel.numberOfMaps) &&
        Objects.equals(this.mapNumber, tournamentMatchCompleteOutputModel.mapNumber) &&
        Objects.equals(this.currentGameTitleMapNameId, tournamentMatchCompleteOutputModel.currentGameTitleMapNameId) &&
        Objects.equals(this.gameTitleMapFileName, tournamentMatchCompleteOutputModel.gameTitleMapFileName) &&
        Objects.equals(this.gameTitleMapProperName, tournamentMatchCompleteOutputModel.gameTitleMapProperName) &&
        Objects.equals(this.gamingServerRegionId, tournamentMatchCompleteOutputModel.gamingServerRegionId) &&
        Objects.equals(this.gamingServerRegionName, tournamentMatchCompleteOutputModel.gamingServerRegionName) &&
        Objects.equals(this.isBracket, tournamentMatchCompleteOutputModel.isBracket) &&
        Objects.equals(this.allowRescheduling, tournamentMatchCompleteOutputModel.allowRescheduling) &&
        Objects.equals(this.willBroadcast, tournamentMatchCompleteOutputModel.willBroadcast) &&
        Objects.equals(this.broadcastUrl, tournamentMatchCompleteOutputModel.broadcastUrl) &&
        Objects.equals(this.automaticGoLiveOnSchedule, tournamentMatchCompleteOutputModel.automaticGoLiveOnSchedule) &&
        Objects.equals(this.minutesAfterStartToForfeit, tournamentMatchCompleteOutputModel.minutesAfterStartToForfeit) &&
        Objects.equals(this.minutesBeforeStartToAllowCheckin, tournamentMatchCompleteOutputModel.minutesBeforeStartToAllowCheckin) &&
        Objects.equals(this.serverSendPlayerSummaryStatistics, tournamentMatchCompleteOutputModel.serverSendPlayerSummaryStatistics) &&
        Objects.equals(this.gamingServerId, tournamentMatchCompleteOutputModel.gamingServerId) &&
        Objects.equals(this.entityPlayerControllerId, tournamentMatchCompleteOutputModel.entityPlayerControllerId) &&
        Objects.equals(this.allTeamAPlayersReady, tournamentMatchCompleteOutputModel.allTeamAPlayersReady) &&
        Objects.equals(this.teamAIsReady, tournamentMatchCompleteOutputModel.teamAIsReady) &&
        Objects.equals(this.allTeamBPlayersReady, tournamentMatchCompleteOutputModel.allTeamBPlayersReady) &&
        Objects.equals(this.teamBIsReady, tournamentMatchCompleteOutputModel.teamBIsReady) &&
        Objects.equals(this.scoreManuallyReportedDateTime, tournamentMatchCompleteOutputModel.scoreManuallyReportedDateTime) &&
        Objects.equals(this.scoreManuallyReported, tournamentMatchCompleteOutputModel.scoreManuallyReported) &&
        Objects.equals(this.scoreManuallyReportedByPlayerId, tournamentMatchCompleteOutputModel.scoreManuallyReportedByPlayerId) &&
        Objects.equals(this.scoreManuallyReportedByTeamA, tournamentMatchCompleteOutputModel.scoreManuallyReportedByTeamA) &&
        Objects.equals(this.scoreManuallyApplyToEntireRound, tournamentMatchCompleteOutputModel.scoreManuallyApplyToEntireRound) &&
        Objects.equals(this.mapsPlayed, tournamentMatchCompleteOutputModel.mapsPlayed) &&
        Objects.equals(this.dispute, tournamentMatchCompleteOutputModel.dispute) &&
        Objects.equals(this.newServerRequested, tournamentMatchCompleteOutputModel.newServerRequested) &&
        Objects.equals(this.newServerRequestedEntityId, tournamentMatchCompleteOutputModel.newServerRequestedEntityId) &&
        Objects.equals(this.newServerRequestedByTeamA, tournamentMatchCompleteOutputModel.newServerRequestedByTeamA) &&
        Objects.equals(this.newServerRequestedCount, tournamentMatchCompleteOutputModel.newServerRequestedCount) &&
        Objects.equals(this.needsAssistance, tournamentMatchCompleteOutputModel.needsAssistance) &&
        Objects.equals(this.allowedSpectators, tournamentMatchCompleteOutputModel.allowedSpectators) &&
        Objects.equals(this.streamingServiceId, tournamentMatchCompleteOutputModel.streamingServiceId) &&
        Objects.equals(this.manualMode, tournamentMatchCompleteOutputModel.manualMode) &&
        Objects.equals(this.manualServerConnectionInfo, tournamentMatchCompleteOutputModel.manualServerConnectionInfo) &&
        Objects.equals(this.streamingService, tournamentMatchCompleteOutputModel.streamingService) &&
        Objects.equals(this.assistanceRequests, tournamentMatchCompleteOutputModel.assistanceRequests) &&
        Objects.equals(this.lastUpdatedDateTime, tournamentMatchCompleteOutputModel.lastUpdatedDateTime) &&
        Objects.equals(this.serverConfigurationFileName, tournamentMatchCompleteOutputModel.serverConfigurationFileName) &&
        Objects.equals(this.matchConnectionInstructions, tournamentMatchCompleteOutputModel.matchConnectionInstructions) &&
        Objects.equals(this.matchAdministratorId, tournamentMatchCompleteOutputModel.matchAdministratorId) &&
        Objects.equals(this.actionLog, tournamentMatchCompleteOutputModel.actionLog) &&
        Objects.equals(this.playback, tournamentMatchCompleteOutputModel.playback) &&
        Objects.equals(this.qualifierGroupNumber, tournamentMatchCompleteOutputModel.qualifierGroupNumber) &&
        Objects.equals(this.isQualifier, tournamentMatchCompleteOutputModel.isQualifier) &&
        Objects.equals(this.hasTieBreaker, tournamentMatchCompleteOutputModel.hasTieBreaker) &&
        Objects.equals(this.tieBreakerCount, tournamentMatchCompleteOutputModel.tieBreakerCount) &&
        Objects.equals(this.mapVotingResult, tournamentMatchCompleteOutputModel.mapVotingResult);
  }

  @Override
  public int hashCode() {
    return Objects.hash(generationTicks, administrators, tournamentProfile, gamingServer, teamAPlayers, teamBPlayers, evidence, issuedGamingServerHistory, endOfMapStatistics, tournamentMatchStateId, tournamentMatchExtendedStateId, requireManualScoreReport, tournamentMatchId, tournamentId, gameTitleId, isTeamTournament, matchIsAwaitingMapVote, matchIsLive, matchLiveDateTime, matchIsComplete, matchCompleteDateTime, matchIsFinalized, matchFinalizedDateTime, enableMatchLobby, allowCheckin, allowCheckinDateTime, scheduledStartDateTime, scheduledForfeitDateTime, entityOwnerId, entityOwnerProfile, entityParticipantA, entityParticipantB, roundNumber, roundLevelTypeId, matchNumber, numberOfMaps, mapNumber, currentGameTitleMapNameId, gameTitleMapFileName, gameTitleMapProperName, gamingServerRegionId, gamingServerRegionName, isBracket, allowRescheduling, willBroadcast, broadcastUrl, automaticGoLiveOnSchedule, minutesAfterStartToForfeit, minutesBeforeStartToAllowCheckin, serverSendPlayerSummaryStatistics, gamingServerId, entityPlayerControllerId, allTeamAPlayersReady, teamAIsReady, allTeamBPlayersReady, teamBIsReady, scoreManuallyReportedDateTime, scoreManuallyReported, scoreManuallyReportedByPlayerId, scoreManuallyReportedByTeamA, scoreManuallyApplyToEntireRound, mapsPlayed, dispute, newServerRequested, newServerRequestedEntityId, newServerRequestedByTeamA, newServerRequestedCount, needsAssistance, allowedSpectators, streamingServiceId, manualMode, manualServerConnectionInfo, streamingService, assistanceRequests, lastUpdatedDateTime, serverConfigurationFileName, matchConnectionInstructions, matchAdministratorId, actionLog, playback, qualifierGroupNumber, isQualifier, hasTieBreaker, tieBreakerCount, mapVotingResult);
  }
  ...
  public String toString() {
    ...
    sb.append("class TournamentMatchCompleteOutputModel {\n");
    ...
    sb.append("    tournamentProfile: ").append(toIndentedString(tournamentProfile)).append("\n");
    sb.append("    gamingServer: ").append(toIndentedString(gamingServer)).append("\n");
    sb.append("    teamAPlayers: ").append(toIndentedString(teamAPlayers)).append("\n");
    sb.append("    teamBPlayers: ").append(toIndentedString(teamBPlayers)).append("\n");
    sb.append("    evidence: ").append(toIndentedString(evidence)).append("\n");
    sb.append("    issuedGamingServerHistory: ").append(toIndentedString(issuedGamingServerHistory)).append("\n");
    sb.append("    endOfMapStatistics: ").append(toIndentedString(endOfMapStatistics)).append("\n");
